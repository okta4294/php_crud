  ...
  <nav class="bg-white border-gray-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between lg:mx-32 p-4">
      <a href="" class="flex items-center">
        <img src="../../Components/images/logo.png" class="h-8 mr-3" alt="" />
        <span class="self-center text-1xl font-semibold whitespace-nowrap text-black">Ini Web</span>
      </a>
      <button
        ...
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white">
          ...
          <li>
            <div v-if="canLogin">
              ...
              <template v-else>
                <Link :href="route('register')" type="button" class="text-black bg-white-700 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0"> Register</Link>
                <Link :href="route('login')" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0"> Log in</Link>
    ...
    <div class="container px-5 py-5">
      <div class="flex flex-col-reverse lg:flex-row items-center lg:py-5 lg:order-first">
        <div class="lg:w-6/12 lg:ms-10 text-black">
          ...
          <span class="self-center text-3xl font-semibold whitespace-nowrap text-black uppercase">Who Am I?</span> <br>
          <span class="self-center text-xl font-semibold whitespace-nowrap text-slate-500 ">Seorang Mahasiswa yang ingin lulus dengan cepat</span>
          <div class="grid grid-cols-1 gap-2 md:flex md:justify-start">
            
            <button type="button" class="bg-gray-300 hover:bg-gray-200 text-black rounded-lg px-4 py-2 mt-7">Get Started</button>
          </div>
        </div>
        <div class="lg:w-6/12">
  ...
  <footer>
    <div className="mx-auto max-w-screen-xl  px-4 sm:px-6">
      <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
        <div className="sm:col-span-12 lg:col-span-3">
          ...
          <div className="text-sm text-gray-600">
            <span class="self-center text-2xl font-semibold whitespace-nowrap text-black uppercase">Okta</span> <br>
            <img src="../../Components/images/logo.png" class="h-40 w-90 mr-3" alt="logo" />
      ...
      <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
        ...
        <div className="text-sm text-gray-600 mr-4">&copy; Zaya Enterprise. All rights reserved.</div>
      </div>
    </div>
  </footer>
</template>
